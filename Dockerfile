...
#        https://master.dl.sourceforge.net/project/xampp/XAMPP%20Linux/5.6.14/xampp-linux-5.6.14-3-installer.run?viasf=1 \
        https://jaist.dl.sourceforge.net/project/xampp/XAMPP%20Linux/5.6.40/xampp-linux-x64-5.6.40-0-installer.run \
	' \ 
